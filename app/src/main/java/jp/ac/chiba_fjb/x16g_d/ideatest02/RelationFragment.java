...
public class RelationFragment extends DialogFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        Cursor res = db.query("select category.category_name,idea.idea_name from idea_log left outer join idea on idea_log.idea_id = idea.idea_id left outer join category on idea_log.category_id = category.category_id where grou_id = '" + grou_id + "' order by category.category_id;");
        idea = new ArrayList<>();
